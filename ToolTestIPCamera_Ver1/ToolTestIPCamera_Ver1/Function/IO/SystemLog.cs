...
namespace ToolTestIPCamera_Ver1.Function.IO
{
    ...
    {
        private static string _dir_logpath = AppDomain.CurrentDomain.BaseDirectory + "LogDetail";
        private static string _dir_Layer2_logpath = AppDomain.CurrentDomain.BaseDirectory + "LogDetail\\Layer2";
        private static string _dir_Layer3_logpath = AppDomain.CurrentDomain.BaseDirectory + "LogDetail\\Layer3";
        private static string _dir_Product_logpath = AppDomain.CurrentDomain.BaseDirectory + "LogDetail\\Product";
        ...
        public static bool Save() {
            try {
                ...
                st.WriteLine(GlobalData.testingDataDUT.SYSTEMLOG);
                st.Dispose();
                return true;
            }
            catch {
